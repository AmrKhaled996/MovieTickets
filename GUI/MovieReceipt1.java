...
//        List<Receipt> receiptses =new ArrayList<Receipt>( Database.getAllReceipts());
//        Receipt receipt = receiptses.get(receiptses.size() - 1); // Use get(size - 1) for the last item
//       var seatsId=" "+receipt.getSeatIDs().get(0);
//        for (int i = 1; i < receipt.getSeatIDs().size(); i++) {
//            seatsId+= ", "+receipt.getSeatIDs().get(i);
//            
//        }
//        // Set text for jLabel1
//        jLabel1.setText("<html>"+"Receipt ID: "+receipt.getID()+
//                        "<hr><br>Name : " + receipt.getCustomerName() +
//                        "<br><br>Movie Name : "  + receipt.getMovieName() +
//                        "<br><br>Total Price : " + receipt.getTotalPrice() + " LE" +
//                        "<br><br>Hall ID : "     + receipt.getHallID() +
//                        "<br><br>Seats :  "+ seatsId+
//                        "<br><br>Duration : "    + Format.duration(receipt.getStartDate(), receipt.getEndDate()) +
//                        "<br><br>Start Date : "  + Format.date(receipt.getEndDate()) +
//                        "<br><br>End Date : "    + Format.date(receipt.getStartDate()) + "</html>");
...
//        jPanel1.add(jLabel1, BorderLayout.NORTH); // Use BorderLayout.NORTH for top placement
//
