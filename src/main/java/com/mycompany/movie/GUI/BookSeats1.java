...
public class BookSeats1 extends javax.swing.JPanel {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (response == JOptionPane.YES_OPTION) {
            ...
            Database.addReceipt(movie.getID(),1 , totalPrice, hall.getID(), Format.seatsIDList(CheckedSeats)); // todo : add the customer
    ...
    private void initComponents1(program prog) {
        ...
        movie=lib.getMovies().get(BookMovie1.MovieId);
