package com.mycompany.movie.Hall;

import com.mycompany.movie.Database;
import static com.mycompany.movie.Hall.enClass.FIRST;
import static com.mycompany.movie.Hall.enClass.SECOND;
import static com.mycompany.movie.Hall.enClass.THIRD;
...
//        Database.updateSeatAvailability(this.Seatid, Hall.this.id , isAvailable);
    }
